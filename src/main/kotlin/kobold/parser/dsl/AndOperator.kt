...
class AndOperator : AndOperatorDSL {
    override infix fun String.and(that: String) = Token(this) and Token(that)
    override infix fun String.and(that: Token) = Token(this) and TerminalByContent(that)
    override infix fun String.and(that: Matcher) = Token(this) and that

    override infix fun Token.and(that: String) = TerminalByContent(this) and Token(that)
    override infix fun Token.and(that: Token) = TerminalByContent(this) and TerminalByContent(that)
    override infix fun Token.and(that: Matcher) = TerminalByContent(this) and that

    override infix fun Matcher.and(that: String) = this and Token(that)
    override infix fun Matcher.and(that: Token) = this and TerminalByContent(that)
